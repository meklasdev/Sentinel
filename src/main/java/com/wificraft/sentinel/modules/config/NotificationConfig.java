...
public class NotificationConfig {
    ...
    public int getActivityThreshold(String activity) {
        return config.getInt("thresholds." + activity.toLowerCase().replace(" ", "_"), 5);
    }
    
    public int getSuspiciousThreshold(String pattern) {
        // Default threshold of 3 matches for any suspicious pattern
        return config.getInt("thresholds.suspicious." + pattern.toLowerCase().replace(" ", "_"), 3);
    }
