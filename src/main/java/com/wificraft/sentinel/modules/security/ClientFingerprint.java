...
public class ClientFingerprint {
    ...
    public ClientFingerprint(Player player) {
        ...
        this.inventory = new ArrayList<ItemStack>(Arrays.asList(player.getInventory().getContents()));
        this.activeEffects = new ArrayList<PotionEffect>(player.getActivePotionEffects());
