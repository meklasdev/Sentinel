...
public class AlertManager {
    ...
    public void createAlert(String title, String description, SeverityLevel severity) {
        // Create alert object for console
        createAlert((Player)null, title, description, severity);
    }
    
    public void createAlert(Player player, String title, String description, SeverityLevel severity) {
        String playerName = player != null ? player.getName() : "CONSOLE";
        Alert alert = new Alert(playerName, title, description, severity);
        createAlert(alert);
    }
